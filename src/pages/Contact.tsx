    ...
    <>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white border border-audrey-earth-light/50 rounded-lg p-6 shadow-sm animate-fade-in opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className="text-audrey-green-dark hover:text-audrey-green font-medium text-sm mt-1 inline-block"
                      >
                        Ver en Google Maps
                      </a>
                    </div>
                  ...
                  <div className="border-t border-audrey-earth-light/50 pt-4 mt-6">
                    ...
                    <div className="flex gap-4">
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className="bg-audrey-cream hover:bg-audrey-green-light w-10 h-10 rounded-full flex items-center justify-center transition-colors"
      ...
      <section className="section-padding bg-audrey-earth-light/20">
        <div className="container-custom">
          <SectionTitle 
            title="Ubicación" 
            subtitle="Encuentra mi estudio en el centro de Madrid"
            centered
          />
          
          <div className="mt-8 h-96 rounded-lg overflow-hidden shadow-md animate-fade-in opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            {/* Replace with actual Google Maps embed */}
            <div className="w-full h-full bg-audrey-cream flex items-center justify-center">
